...
coupon; the owner selected Ø10.30, and the final serviceable ABS receiver spans 20.0 mm with
0.8 mm bearing clearance per side. PA-CF needs a new calibration. Design record **§4**.
