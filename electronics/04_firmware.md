...
| 3 | 100 mm drop = 3.23 J vs 3.553 J, "~10% margin" | **A 100 mm free drop bottoms out.** The brief omits gravity work during the 50 mm of compression. True demand 4.85 J vs 3.55 J available. **Passive free-drop capacity is ~49 mm** (spring-rate method, more conservative than the ~60 mm energy method — see `fusion_brief_single_leg_rig.md` §4.3). |
