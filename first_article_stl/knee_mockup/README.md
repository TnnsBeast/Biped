...
provisional link for a steel-pin trial. The owner selected Ø10.30 for the active
ABS production receiver after Ø10.25 passed the initial 19.0 mm coupon. The
[full-span ladder](../knee_pin_fit/) is now an optional diagnostic.
[Result and remaining checks](../../evidence/knee_fit/2026-09-15_steel_pin_provisional_shin/).
