...
- **The deferred source records the intended topology.** Its builder now inherits five
  Ø4.5 × 6.0 M3 pockets and
  four full-depth source-updated Ø5.3 M4 receivers for the owner-held M4 × 8
  inserts. The stripped carriage was not rebuilt or released. Do not print it
  for Mode A; repeat the coupon for its eventual material/profile and rebuild it
  through Fusion when Mode B returns. The canonical
  disposition is in
...
- **The bed-facing face is the one that has to be flat.** It bears on
  ...
  bridging. The released bores are **Ø4.5 × 6.0** for 5 mm Voron-style M3
  inserts, with 1 mm installation space and a 6 mm printed floor. The owner
  selected Ø4.5 on the same-profile ABS ladder; Fusion verified and re-exported
  the stand after promotion.
...
- Same five-hole panel interface as §1, but do not print or install inserts from
  the current STL. Rebuild the five bores to the verified Voron-style pocket in
  Fusion first; the 12 mm web preserves a deep floor after correction.
