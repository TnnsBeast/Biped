...
weight. The owner has requested that mock-up, but paused its preparation to reconcile the spring recommendation. No temporary-pin or distal mock-up STL is released yet. In parallel, run
...
| Main knee spring | **Procurement/CAD mismatch:** original CAD uses 55 mm free length; the assistant later recommended Yellow / OD18 / ID9 / 50 mm and promised cartridge changes that were not completed. The completed-order screenshot confirms the recommended 50 mm option; the owner reports 150 mm physically received. Verify actual length with a ruler before reordering. A 50 mm adaptation must also resolve Ø13.4 spigots, Ø10 washer stack and Ø13 bumper inside ID9, installed length/preload and travel. [Reconciliation and Fusion evidence](evidence/springs/2026-09-05_reconciliation/). |
