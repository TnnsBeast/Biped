...
<!-- PRINT_QUEUE_START -->
## PRINT THIS NEXT — ABS first article
...
clamp or retaining compound. [Full test and acceptance instructions](first_article_stl/assembly_dry_fit/README.md#batch-3--unloaded-abs-proximal-link-bearing-rehearsal).

**Hold:** do not print the distal link yet; the Ø10 h6 knee pin and its DFM/
...
| Physical hardware | **Both actuators and the 6800-2RS bearings are in hand.** Photo evidence: [`evidence/actuators/2026-08-20_received/`](evidence/actuators/2026-08-20_received/). The ABS actuator-interface results are: GIM6010 housing PASS, original GIM6010 output Ø4.05 bore clearance FAIL followed by Ø4.15 ABS PASS, GIM4305 housing PASS with the real M2.5 screws, and GIM4305 output PASS. The two GIM4305 coupons are opposite-face, one-at-a-time gauges and intentionally do not nest. The actual Ø4.15 ABS shoulder hub PASSes all three pins and all six M3 output positions. The corrected shoulder-plate-first assembly sequence is **physically verified**. Use M3 × 8 housing screws; ×10 bottoms before clamping. The original Ø19.00 bearing coupon is a physical FAIL; the owner's Ø19.10 ladder bore is an **ABS PASS** with firm thumb pressure, square seating, no rock and tool-free removal. The first proximal-link print exposed a DFM defect: the unequal-circle outline used a chord-side angle, leaving both round ends 0.608 mm below the apparent straight bed face. The exact external-tangent geometry is now corrected and a bed-ready Ø19.10 ABS STL is exported and `CAD PATH VERIFIED`; its bearing installation remains the physical rehearsal. No loaded leg or wiring has been assembled yet. |
...
**without rotating it** as the unloaded ABS physical assembly article, then
